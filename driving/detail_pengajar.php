...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysql_query("SELECT * FROM data_pengajar WHERE id='$_GET[kd]'");
                    ...
                    <td width="550"><?php echo $data['no_hp']; ?></td>
                    </tr>
					<tr>
                    <td>Nama CV</td>
                ...
                <a href="pengajar.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
