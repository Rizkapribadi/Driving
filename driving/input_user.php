        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <!-- Main content nya -->
                 <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert_user.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input_user.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
              ...
              <!-- row end -->
                  ...
                  <center>Copyright &copy <a  target="_blank">Aceh Driving School</a> 2016</center>
