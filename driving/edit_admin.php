...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" action="update_admin.php" method="post" name="form1" id="form1">
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="#" target="_blank">Aceh Driving School</a> 2016
                </div>
            </aside><!-- /.right-side -->
