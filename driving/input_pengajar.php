...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert_pengajar.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">ID Pengajar</label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama CV</label>
                              <div class="col-sm-8">
                                  <input name="nama_cv" type="text" id="nama_cv" class="form-control" placeholder="Nama CV" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tarif</label>
                              <div class="col-sm-8">
                                  <input name="tarif" class="form-control" id="tarif" type="text" placeholder="Tarif" required />
                              </div>
                          </div>
						  <div class="form-group">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input_pengajar.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
