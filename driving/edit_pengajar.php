...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update_pengajar.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="no_hp" type="text" id="no_hp" class="form-control" placeholder="No HP" value="<?php echo $data['no_hp']; ?>" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama CCV</label>
                              <div class="col-sm-8">
                                  <input name="nama_cv" type="text" id="nama_cv" class="form-control" placeholder="Nama CV" value="<?php echo $data['nama_cv']; ?>" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tarif</label>
                              <div class="col-sm-8">
                                  <input name="tarif" type="text" id="tarif" class="form-control" placeholder="Tarif" value="<?php echo $data['tarif']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <img src="" height="250" width="250" alt="Foto Anggota" style="margin-bottom: 10px;" /><br />
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="pengajar.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
